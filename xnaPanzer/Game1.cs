...
namespace xnaPanzer
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            Unit.SpriteBatch = this.m_spriteBatch;
            Unit.PixelWidth = m_UNIT_IMAGE_WIDTH;
            Unit.PixelHeight = m_UNIT_IMAGE_HEIGHT;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            for (int x = this.m_ViewportLeftHexX; x < rightmostHexX; x++) {
                ...
                for (int y = this.m_ViewportTopHexY; y < bottommostHexY; y++) {
                    ...
                    if (id >= 0) {
                        this.m_Units[id].Draw(this.m_spriteBatch, destRect.X, destRect.Y);
                    }
